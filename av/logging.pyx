...
log_class.item_name = <const char *(*)(void *) except * nogil>log_context_name
...
cdef void log_callback(void *ptr, int level, const char *format, lib.va_list args) except * nogil:
